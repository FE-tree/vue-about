<template>
    <div class="layout">
        ...
        <div class="all-container">
            ...
            <div class="container">
                <span class="list" v-for="(e,i) in rocks" :key="i" :style="`transform: translate(${cssTransition(e)});display: ${e?'':'none'}`">
                    <span class="inner" :id="`r${e&&e.id}`" :style="`backgroundColor: ${e ? e.color : ''}`">{{e? e.num:''}}</span>
                </span>
            </div>
        </div>
        <!-- <div class="show">
